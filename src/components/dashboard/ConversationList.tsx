  ...
  return (
    <div
      ...
      className={cn(
        ...
        isSelected && !selectionMode && "bg-accent border-l-2 border-l-primary relative z-10 rounded-l-xl -mr-3 pr-[calc(1rem+12px)] border-b-0 shadow-[0_1px_0_hsl(var(--accent)),0_-1px_0_hsl(var(--accent))]",
