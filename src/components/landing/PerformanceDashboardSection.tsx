      ...
      <div className="reveal opacity-0 translate-y-6 transition-all duration-700" style={{ transitionDelay: '0.15s' }}>
        <div className="rounded-3xl overflow-hidden" style={{ backgroundColor: '#1A1614' }}>
          ...
          <div className="mx-4 rounded-xl overflow-hidden border border-white/10">
            ...
            <div className="p-3 space-y-2.5" style={{ backgroundColor: '#222' }}>
              ...
              <div className="max-w-[85%]">
                <div className="rounded-xl rounded-tl-sm px-3 py-2 text-xs text-white/90" style={{ backgroundColor: '#333' }}>
              ...
              {/* Typing indicator */}
              <div className="max-w-[85%]">
                <div className="inline-flex gap-1 items-center rounded-xl rounded-tl-sm px-3.5 py-2.5" style={{ backgroundColor: '#333' }}>
                  {[0, 1, 2].map((i) => (
                    <span
                      key={i}
          ...
          <div className="mx-4 mt-4 rounded-xl border border-white/10 divide-y divide-white/10 overflow-hidden">
            {metrics.map((m) => (
              <div key={m.label} className="flex items-center justify-between px-4 py-2.5" style={{ backgroundColor: '#222' }}>
          ...
          {/* HIPAA strip */}
          <div className="mx-4 mt-3 mb-4 rounded-lg flex items-center justify-center gap-2 px-3 py-2" style={{ backgroundColor: 'rgba(34,197,94,0.12)' }}>
