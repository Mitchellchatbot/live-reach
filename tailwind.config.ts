  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "float-in-left": "float-in-left 0.7s cubic-bezier(0.22, 1, 0.36, 1) both",
        "float-in-right": "float-in-right 0.7s cubic-bezier(0.22, 1, 0.36, 1) both",
        "float-in-up": "float-in-up 0.7s cubic-bezier(0.22, 1, 0.36, 1) both",
      },
    },
  },
